...
A sensitivity analysis was conducted for the choice of reference libraries. We used Illumina Miseq 2x250 16S region amplicon data collected by Schloss et al. (2012) for a study investigating the stabilization of the murine microbiome after weaning. Sequence files were extracted from the zip folder.
